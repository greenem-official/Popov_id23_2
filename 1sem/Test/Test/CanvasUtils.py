...
def drawRectAt(painter: QPainter, data: Data, raw_pos, size, fill_color, outline_color=None, outline_width=2, displaySpaceAlready=False):
...
def drawRectAtExact(painter: QPainter, data: Data, raw_pos, raw_pos2, fill_color, outline_color=None, outline_width=2, displaySpaceAlready=False):
    if not displaySpaceAlready and data.navigation is not None:
        point1 = data.navigation.convertPosAbstractToDisplay((raw_pos[0], raw_pos[1]))
        point2 = data.navigation.convertPosAbstractToDisplay((raw_pos2[0], raw_pos2[1]))
    else:
        point1 = (raw_pos[0], raw_pos[1])
        point2 = (raw_pos2[0], raw_pos2[1])
